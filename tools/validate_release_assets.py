...
REPO_NAME = "bioclip2-biodiversity-pipeline"
NOTEBOOK_NAME = "bioclip2_biodiversity_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "imageomics/bioclip-2"
...
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/bioclip2_biodiversity_sample_dataset.csv",
    "outputs/bioclip2_biodiversity_contact_sheet.png",
    "outputs/bioclip2_biodiversity_embeddings.csv",
    "outputs/bioclip2_biodiversity_evaluation_report.json",
    "outputs/bioclip2_biodiversity_predictions.csv",
    "outputs/bioclip2_biodiversity_adapter",
    "outputs/bioclip2_biodiversity_result.json",
)
CODE_MARKERS = (
    # Stage 4: embedded sample, validation, stratified split, class prompts
    "USE_BYOD = False",
    ...
    # Stage 6: embeddings and reproducibility
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    1_519: "imageomics/bioclip-2 2957b32 .gitattributes (not staged)",
    627_446: "image bytes of the 48 embedded CC0 JPEGs in sample_data.py",
    949_467: "committed size of src/bioclip2_biodiversity_pipeline/sample_data.py (LF endings)",
    2_224_081: "imageomics/bioclip-2 2957b32 tokenizer.json (not staged)",
    1_710_639_510: "imageomics/bioclip-2 2957b32 open_clip_pytorch_model.bin (not staged)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "100ae1f6255659d04d95309e27537c6c0f6acd4d05cd5cff23714c1879ea32a4": "SHA-256 of the fine-tuned adapter from the build smoke run (run record)",
    "f8fc68cf251e03655e343fd4ab3f49556248350d0d77ba4261698602e4a33cc6": "dataset_digest over the 48 embedded iNaturalist sample records",
}
